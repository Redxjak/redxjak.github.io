const CACHE = "grubclique-web-v075-hunt-activity-22";
const SHELL = ["./", "app.css?v=22", "app.js?v=22", "../../assets/analytics-config.js", "../../assets/analytics.js", "manifest.webmanifest", "../assets/app-icon.png"];
